...
const EditTransaction = React.lazy(() => import('./components/EditTransaction'));
...
const CreateAccForm = React.lazy(() => import('./components/CreateAccForm'));
const TransactionForm = React.lazy(() => import('./components/TransactionForm'));
const AccountDetail = React.lazy(() => import('./components/AccountDetails'));
